#ifndef M4RADIO_ROUTER_H
#define M4RADIO_ROUTER_H
#include <stdbool.h>
#include <stdint.h>

#define M4RADIO_ROUTER_MODE_NEVER  (0)
#define M4RADIO_ROUTER_MODE_ALWAYS (1)
#define M4RADIO_ROUTER_MODE_TIMED  (2)
#define M4RADIO_ROUTER_MODE_COUNT  (3)

void m4radio_router_init(void);
void m4radio_router_handle_can(uint16_t msg_id, bool rtr,

...
static void ublox_can_send_pvt(ublox_pvt_t *pvt) {
   m4can_send_i32(CAN_MSG_ID_M4RADIO_GPS_LATLNG, pvt->lat, pvt->lon, 2);
   m4can_send_i32(CAN_MSG_ID_M4RADIO_GPS_ALT, pvt->height, pvt->h_msl, 2);
   m4can_send_u8(CAN_MSG_ID_M4RADIO_GPS_TIME, pvt->year, pvt->year>>8,
                 pvt->month, pvt->day, pvt->hour, pvt->minute, pvt->second,
                 pvt->valid, 8);
   m4can_send_u8(CAN_MSG_ID_M4RADIO_GPS_STATUS, pvt->fix_type, pvt->flags,
